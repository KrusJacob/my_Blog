...
const ProfilePage = () => {
  ...
  return (
    <div>
      ...
      <div className="flex flex-col gap-10 bg-slate-200 bg-opacity-50 border shadow-md shadow-slate-400 px-4 md:px-8 py-4 min-h-[400px] mt-2 text-base md:text-2xl ">
        <ProfileForm />
