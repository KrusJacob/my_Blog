...
const PostItem = ({ post, onClick }: { post: IPost; onClick: (id: number) => void }) => {
  return (
    <motion.div
      ...
      className="border border-[var(--purpleColor)] text-[var(--purpleColor)] py-1 px-3 md:px-6  flex bg-slate-50 rounded justify-between items-center cursor-pointer group : hover:bg-[var(--purpleColor)] hover:text-white duration-200"
    >
